    ...
    class handler implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae)
        {
            ...
            if(ae.getSource()==SignIn||ae.getSource()==t_pass)
            {
            	...
            	PreparedStatement pra1,pra=conn.prepareStatement(query);
            	String query1="select * from pdata where username=? order by today";
            	pra.setString(1,t_name.getText());
            	pra.setString(2,t_pass.getText());//wrong email id and password is not checking add that 
            	...
            	else
            	{
            		...
            		pra1.setString(1, rs.getString(1));
            		ResultSet ps=pra1.executeQuery();
            		
            		//Index in=new Index();
            		//rs for user data ps for medical records
            		swing_sample in=new swing_sample(rs,ps);
